  ...
  async () => {
    try {
      const res = await axios.get(
        "https://notes-share-server.herokuapp.com/api/questions"
      );
      if (res.data) {
        return res.data;
      }
  ...
  async (questionData, { getState }) => {
    ...
    try {
      const res = await axios({
        method: "delete",
        url: `https://notes-share-server.herokuapp.com/api/questions/${id}`,
        headers: {
          Authorization: `Bearer ${token}`,
        },
        data: questionData,
...
export const questionDetails = createAsyncThunk(
  ...
  async id => {
    try {
      const res = await axios.get(
        `https://notes-share-server.herokuapp.com/api/question/${id}`
      );
      if (res.data) {
        return res.data;
      }
    ...
    if (file) {
      ...
      if (commentFileUrl) {
        const response = await fetch(
          "https://notes-share-server.herokuapp.com/api/answers",
          {
            method: "put",
            headers: {
...
export const deleteAnswer = createAsyncThunk(
  ...
  async (answerData, { getState }) => {
    ...
    try {
      const res = await axios({
        method: "delete",
        url: "https://notes-share-server.herokuapp.com/api/answers",
        headers: {
          Authorization: `Bearer ${token}`,
        },
        data: answerData,
