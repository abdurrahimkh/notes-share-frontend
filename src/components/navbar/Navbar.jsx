            ...
            <>
              ...
              <div className="dropdown dropdown-end ">
                <label tabIndex="0" className=" mt-1  flex ">
                  ...
                  />
                  <div class="z-2 absolute left-7 top-0 my-1 h-3 w-3 rounded-full border-2 border-white bg-green-400"></div>
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="ml-4 mt-2 hidden h-5 w-5 text-gray-500 transition group-hover:text-gray-700 sm:block"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                  >
                    <path
