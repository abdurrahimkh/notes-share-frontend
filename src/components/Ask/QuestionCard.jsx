...
const QuestionCard = ({ question, id }) => {
  ...
  return (
    <div className="relative mx-4 my-10 flex max-w-md rounded-lg border-2 bg-white shadow-lg md:mx-auto md:max-w-2xl ">
      <div className="flex items-start px-4 py-6">
        ...
        <div>
          ...
          <label for="delete-question-modal" className="absolute top-2 right-3">
            <DeleteQuestionModal id={question?._id} />
            {loggedInUser === id && (
              <i className="bi bi-x  text-2xl hover:cursor-pointer "></i>
            )}
          </label>
