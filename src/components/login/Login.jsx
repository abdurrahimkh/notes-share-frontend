  ...
  return (
    <div className="flex min-h-screen p-6 md:min-h-[90vh] md:items-center">
      <motion.div
        initial={{ x: "50%" }}
        animate={{ x: 0 }}
        className="shadow-xlmd:mt-0 mx-auto mt-16 h-full max-w-md flex-1 overflow-hidden rounded-lg border border-blue-300 bg-base-100"
      >
        <div className="p-6">
          ...
          <button
            ...
            className="focus:shadow-outline-gray flex w-full items-center justify-center rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium leading-5 text-gray-700 transition-colors duration-150 hover:border-gray-500 focus:border-gray-500 focus:outline-none active:bg-transparent active:text-gray-500 "
          >
            <svg
              className="mr-1"
              stroke="currentColor"
