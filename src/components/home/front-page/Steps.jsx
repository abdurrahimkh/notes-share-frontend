            ...
            <div className="sm:mr-5">
              <div className="my-3 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50 sm:h-24 sm:w-24">
                <img
                  ...
                  src="https://cdn-icons-png.flaticon.com/512/2521/2521826.png"
                />
              </div>
            </div>
            <div>
          ...
          <div className="flex flex-col pb-6 sm:flex-row sm:items-center sm:pb-0">
            <div className="sm:mr-5">
              <div className="my-3 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50 sm:h-24 sm:w-24">
                <img
                  className="text-deep-purple-accent-400 h-12 w-12 sm:h-16 sm:w-16"
                  src="https://cdn-icons-png.flaticon.com/512/2522/2522270.png"
                />
              </div>
            </div>
            <div>
          ...
          <div className="flex flex-col pb-6 sm:flex-row sm:items-center sm:pb-0">
            <div className="sm:mr-5">
              <div className="my-3 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50 sm:h-24 sm:w-24">
                <img
                  className="text-deep-purple-accent-400 h-12 w-12 sm:h-16 sm:w-16"
                  src="https://cdn-icons-png.flaticon.com/512/2521/2521735.png"
                />
              </div>
            </div>
            <div>
          ...
          <div className="flex flex-col pb-6 sm:flex-row sm:items-center sm:pb-0">
            <div className="sm:mr-5">
              <div className="my-3 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50 sm:h-24 sm:w-24">
                <img
                  className="text-deep-purple-accent-400 h-12 w-12 sm:h-16 sm:w-16"
                  src="https://cdn-icons-png.flaticon.com/512/5957/5957262.png"
                />
              </div>
            </div>
            <div>
